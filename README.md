...
<p align="center"><img src="https://raw.githubusercontent.com/Cruxia-Labs/er1-spec/v1.0.1/media/verify_hero.gif" alt="Two independent verifiers re-deriving the same verdict from the frozen golden vectors, offline" width="760"></p>
...
[`SCOPE_OF_CERTIFICATION.md`](https://github.com/Cruxia-Labs/er1-spec/blob/v1.0.1/SCOPE_OF_CERTIFICATION.md).
...
| [`IMPLEMENTATIONS.md`](https://github.com/Cruxia-Labs/er1-spec/blob/v1.0.1/IMPLEMENTATIONS.md) | The conformance roster — three verifiers on disjoint stacks (Python, Node, browser WebCrypto), and an open invitation to add an independent one in your language. |
| [`KEYS.md`](https://github.com/Cruxia-Labs/er1-spec/blob/v1.0.1/KEYS.md) | Announced signing keys and key tiers. A key adds continuity, never the integrity claim — that stays recomputation. |
...
[`CONFORMANCE.md`](https://github.com/Cruxia-Labs/er1-spec/blob/v1.0.1/CONFORMANCE.md)), the primitive hashes,
...
[`IMPLEMENTATIONS.md`](https://github.com/Cruxia-Labs/er1-spec/blob/v1.0.1/IMPLEMENTATIONS.md).)
...
[`LICENSE`](https://github.com/Cruxia-Labs/er1-spec/blob/v1.0.1/LICENSE)) — chosen for its explicit
